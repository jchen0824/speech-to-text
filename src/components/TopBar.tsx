...
const TopBar = ({ isListening }: TopBarProps) => {
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-slate-200 bg-white px-6 py-3">
      <div className="flex items-center gap-4">
        ...
        <h2 className="hidden text-lg font-bold leading-tight tracking-[-0.015em] text-slate-900 sm:block">
          Meeting Scribe
        </h2>
        {isListening ? (
          <div className="ml-2 flex h-7 items-center gap-2 rounded-full bg-slate-100 pl-2 pr-3 text-xs font-medium text-slate-600">
            <span
